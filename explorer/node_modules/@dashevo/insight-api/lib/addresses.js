...
console.log(body);
    ...
    var transformed = {
      ...
      unconfirmedBalance: body.body[0]["unconfirmedBalance"],
      unconfirmedBalanceSat: body.body[0]["unconfirmedBalance"] * 1e8,
      unconfirmedTxApperances: body.body[0]["txCountUnconfirmed"],  // will be deprecated in a future update

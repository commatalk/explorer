...
####  `checkedSerialize`
Return an hexa string that can be used in bltgd CLI
####  `serialize`
...
var jsonProposal = {
  ...
  url:"http://www.bltg.org/proposal/first_proposal"
};
...
```javascript
proposal.url="http://bltg.org/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://bltg.org/fixedUrl"
